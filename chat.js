...
// --- 設定 ---
// 【APIキー切り替えメモ】
// 無料枠キー: AIzaSyC70tkav7cxlplnSI2S2yodzw_9jseW0Xo （現在使用中・費用ゼロ）
// 有料キー(Tier1): AIzaSyAzNv5lTbhEHyhEKePMlxLRLA2ANMpbccs （広告収入が始まったら切り替える）
const CONFIG = {
  GEMINI_API_KEY: 'AIzaSyC70tkav7cxlplnSI2S2yodzw_9jseW0Xo',
  FIREBASE_CONFIG: {
...
## 投票
- 2枚の写真から良い方に投票。基本5票/日、NFT保有者+5票、サブスク+2票
...
## 提携・受賞
- H.I.S.提携：旅行×写真×Earn、地域連動ボーナス（指定都道府県で報酬最大+20%）。今始めるとHISコラボのフリーカメラがもらえる（通常のフリーカメラより効率が高い設定）
